...
template<>
struct geometry_concept<seg_diag_detail::IPoint> { typedef point_concept type; };
...
template<>
struct geometry_concept<seg_diag_detail::ISegment> { typedef segment_concept type; };
